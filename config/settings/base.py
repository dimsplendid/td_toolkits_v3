...
APPS_DIR = BASE_DIR / "td_toolkits_v3"
...
DATABASES = {
    "default": env.db(
        "DATABASE_URL",
        default=f"sqlite:///{str(BASE_DIR / 'td_toolkits_v3.db')}",
    )
}
...
LOCAL_APPS = [
    ...
    "td_toolkits_v3.autofill.apps.AutofillConfig", # Auto Fill tools
]
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "td_toolkits_v3.utils.context_processors.settings_context",
            ],
        },
    }
]
...
ADMINS = [("andrew.tseng", "andrew.tseng@innolux.com")]
